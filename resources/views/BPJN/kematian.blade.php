    ...
    <div id="signupbox" style="margin-top:50px"
        ...
        <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title">Formulir Surat Kematian</div>
            </div>
...
@csrf
                    ...
                    <div class="form-group">
                        <label for="nama" class="col-md-3 control-label" style="text-align:left;">Nama</label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        <label for="nik" class="col-md-3 control-label" style="text-align:left;">NIK</label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        <label for="tempat_tgl_lahir" class="col-md-3 control-label" style="text-align:left;">Tempat/Tanggal Lahir</label>
                        <div class="col-md-9">
                            <input type="tempat_tgl_lahir" class="form-control" name="tempat_tgl_lahir" placeholder="Tempat/Tanggal Lahir">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="agama" class="col-md-3 control-label" style="text-align:left;">Agama</label>
                        <div class="col-md-9">
                            <input type="agama" class="form-control" name="agama" placeholder="Agama">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="hari" class="col-md-3 control-label" style="text-align:left;">Hari</label>
                        <div class="col-md-9">
                            <input type="hari" class="form-control" name="hari" placeholder="hari">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="tgl" class="col-md-3 control-label" style="text-align:left;">Tanggal</label>
                        <div class="col-md-9">
                            <input type="tgl" class="form-control" name="tgl" placeholder="Tanggal">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="bertempat" class="col-md-3 control-label" style="text-align:left;">Bertempat</label>
                        <div class="col-md-9">
                            <input type="bertempat" class="form-control" name="bertempat" placeholder="Bertempat">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="penyebab" class="col-md-3 control-label" style="text-align:left;">Penyebab</label>
                        <div class="col-md-9">
                            <input type="penyebab" class="form-control" name="penyebab" placeholder="Penyebab">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="nama_pelapor" class="col-md-3 control-label" style="text-align:left;">Nama Pelapor</label>
                        <div class="col-md-9">
                            <input type="nama_pelapor" class="form-control" name="nama_pelapor" placeholder="Nama Pelapor">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="nik_pelapor" class="col-md-3 control-label" style="text-align:left;">NIK Pelapor</label>
                        <div class="col-md-9">
                            <input type="nik_pelapor" class="form-control" name="nik_pelapor" placeholder="NIK Pelapor">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="tempat_tgl_lahir_pelapor" class="col-md-3 control-label" style="text-align:left;">Tempat/Tanggal Lahir Pelapor</label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        <label for="pekerjaan" class="col-md-3 control-label" style="text-align:left;">Pekerjaan</label>
                        <div class="col-md-9">
